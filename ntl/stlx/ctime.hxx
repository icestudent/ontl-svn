...
#else
  ///\note ISO9899 266) In order to measure the time spent in a program, the clock 
  /// function should be called at the start of the program and its return value
  /// subtracted from the value returned by subsequent calls.
  return ntl::nt::query_system_time();
#endif
}
