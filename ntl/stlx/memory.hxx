 ...
 *@{*/
/**\defgroup  lib_memory *************** [20.7] Memory **********************
 *@{*/
...
/// 20.7.11.4 unique_ptr for array objects with a compile time length [unique.ptr.compiletime]
...
///\name 20.7.11.5 unique_ptr specialized algorithms [unique.ptr.special]
