  ...
  {	
    ...
    namespace impl
    {
      ...
      struct typelist_traits
      {
        ...
        typedef typename stlx::conditional< sizeof(ttl::data_holder<T1>) >=sizeof(ttl::data_holder<typename tail::largest_type>),
          T1,
...
#undef TTL_META_TYPELIST_GET
    ...
    struct equivalent_types: 
      stlx::integral_constant<bool, stlx::is_same<typename stlx::decay<T>::type, typename stlx::decay<U>::type>::value>
    {};
    ...
    private:
      ...
      typedef typename stlx::conditional< equivalent_types<typename get_type::type, T>::value,
        get_type,
    ...
    private:
      ...
      typedef typename stlx::conditional< stlx::is_same<typename get_type::type, T>::value,
        get_type,
        find<T,L,N+1> 
      >::type found;
