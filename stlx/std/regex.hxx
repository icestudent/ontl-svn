...
namespace stlx
{
  ...
  class regex_error: public stlx::runtime_error 
  {
  public:
  ...
  struct regex_traits
  {
    ...
    typedef stlx::basic_string<char_type> string_type;
    typedef stlx::locale locale_type;
    typedef bitmask_type char_class_type;

    regex_traits();

    static stlx::size_t length(const char_type* p);
  ...
  class sub_match: public stlx::pair<BidirectionalIterator, BidirectionalIterator> 
  {
  public:
  ...
  public:
    ...
    typedef stlx::ptrdiff_t difference_type;
    typedef const value_type* pointer;
    typedef const value_type& reference;
    typedef stlx::forward_iterator_tag iterator_category;
  ...
  public:
    ...
    regex_token_iterator(BidirectionalIterator a, BidirectionalIterator b, const regex_type& re, const stlx::vector<int>& submatches, regex_constants::match_flag_type m = regex_constants::match_default);
    template <stlx::size_t N>
