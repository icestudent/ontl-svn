...
class list
{
  ...
  private:
    ...
    : public stlx::iterator<bidirectional_iterator_tag, value_type,
...
#endif
    {
      stlx::swap(size_, x.size_);
      stlx::swap(head.next, x.head.next);
      stlx::swap(head.prev, x.head.prev);
      stlx::swap(node_allocator, x.node_allocator);
    }
