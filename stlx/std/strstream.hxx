...
#ifndef STLX_STRSTREAM
#define STLX_STRSTREAM
  ...
  protected:
    ...
    virtual int_type overflow(int_type c = EOF)
    {
      ...
      if ( pptr() >= epptr()
        ...
        && !(strmode & frozen) )
      {
        const streamsize newsize = ntl::grow_heap_block_size(alsize);
...
//    __forceinline
    ...
    {
      return palloc ? (char*)palloc(size) : new (stlx::nothrow) char[size];
    }
...
class ostrstream : public ostream//basic_ostream<char>
{
  public:
    ...
    ///   designated by s. The constructor is strstreambuf(s, n, s + stlx::strlen(s)).
...
class strstream : public iostream//basic_iostream<char>
{
  public:
    ...
    ///     is designated by s. The constructor is strstreambuf(s,n,s + stlx::strlen(s)).
