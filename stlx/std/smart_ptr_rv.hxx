...
namespace stlx
{
  ...
  *@{*/
  ...
  class bad_weak_ptr : public stlx::exception
  {
  public:
...
#ifndef NTL__CXX_EF
    {
      static_assert(false, "Use explicit move semantic instead of implicit copying.");
    }
#endif
    ;
  };
...
#ifdef NTL__CXX_VT
  /// 1 Requires: The expression new (pv) T(stlx::forward<Args>(args)...), where
  ...
  ///   or new (pv) T(stlx::forward<Args>(args)...). The template allocate_shared
