...
class allocator
{
  ...
  public:
    ...
    {
      __assume(p);
      ::new((void *)p) T(stlx::forward<Arg>(val));
    }
    ...
    {
      __assume(p);
      ::new((void *)p) T(stlx::forward<Arg>(val), stlx::forward<Arg2>(val2));
    }
    ...
    {
      __assume(p);
      ::new((void *)p) T(stlx::forward<Arg>(val), stlx::forward<Arg2>(val2), stlx::forward<Arg3>(val3));
    }
    ...
    {
      __assume(p);
      ::new((void *)p) T(stlx::forward<Arg>(val), stlx::forward<Arg2>(val2), stlx::forward<Arg3>(val3), stlx::forward<Arg4>(val4));
    }
    ...
    {
      __assume(p);
      ::new((void *)p) T(stlx::forward<Arg>(val), stlx::forward<Arg2>(val2), stlx::forward<Arg3>(val3), stlx::forward<Arg4>(val4), stlx::forward<Arg5>(val5));
    }
#else
    __forceinline
    ...
    {
      __assume(p);
      ///\todo ::new((void *)p ) T(stlx::forward<U>(val))
      ::new((void *)p) T(val);
    }
#endif
