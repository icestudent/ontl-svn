...
//template <> struct hash<stlx::string>; // in <string>
//template <> struct hash<stlx::u16string>;
//template <> struct hash<stlx::u32string>;
//template <> struct hash<stlx::wstring>;

//template <> struct hash<stlx::error_code>; // in <system_error>
//template <> struct hash<stlx::thread::id>; // in <thread>
