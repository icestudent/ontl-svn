...
#pragma region thread.once
  ...
  {
    static_assert(stlx::is_member_function_pointer<Callable>::value == false, "must not be a member pointer function");
    if(flag.ready())
      return;
  ...
  void call_once(once_flag& flag, Callable func, Arg1 arg1)
  {
    ...
    once_flag::lock lock(flag);
    if(!flag.ready()){
      __::call_once_impl<stlx::is_member_function_pointer<Callable>::value>::call_once(func, arg1);
      flag.set_ready();
    }
  }
  ...
  void call_once(once_flag& flag, Callable func, Arg1 arg1, Arg2 arg2)
  {
    ...
    once_flag::lock lock(flag);
    if(!flag.ready()){
      __::call_once_impl<stlx::is_member_function_pointer<Callable>::value>::call_once(func, arg1, arg2);
      flag.set_ready();
    }
  }
  ...
  void call_once(once_flag& flag, Callable func, Arg1 arg1, Arg2 arg2, Arg1 arg3)
  {
    ...
    once_flag::lock lock(flag);
    if(!flag.ready()){
      __::call_once_impl<stlx::is_member_function_pointer<Callable>::value>::call_once(func, arg1, arg2, arg3);
      flag.set_ready();
    }
  }
