 ...
 */
  ...
  template <class T1, class T2> 
  struct tuple_size<stlx::pair<T1, T2> >
    :integral_constant<size_t, 2>
  {};

  template <size_t I, class T1, class T2>
  struct tuple_element<I, stlx::pair<T1, T2> >; // undefined
  template <class T1, class T2>
  struct tuple_element<0, stlx::pair<T1, T2> > { typedef T1 type; };
  template <class T1, class T2> 
  struct tuple_element<1, stlx::pair<T1, T2> > { typedef T2 type; };

  template<size_t I, class T1, class T2>
  typename tuple_element<I, stlx::pair<T1, T2> >::type& get(stlx::pair<T1, T2>& p)
  {
  ...
  template<size_t I, class T1, class T2> 
  const typename tuple_element<I, stlx::pair<T1, T2> >::type& get(const stlx::pair<T1, T2>& p)
  {
    static_assert(I < 2, "I out of bounds");
    return __::tuple_pair<T1, T2>::get(p, ttl::meta::int2type<I>());
  }
